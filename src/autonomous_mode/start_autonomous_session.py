...
from src.lib.constants import BALLS_PER_DELIVERY, ROBOT_TO_POINT_DISTANCE_BEFORE_BURST, BALL_COUNT_ESTIMATE_INVALIDATION_SECONDS, WIN_MESSAGE, GO_TO_NORMAL_BALL_APPROACH_RADIUS, ARUCO_OFFSET_X
...
def _collect_ball(ball: Ball, connection: RobotConnection, state: ArenaState) -> None:
    ...
    if is_edge_ball:
        ...
        go_to(state, connection, ball.position, ARUCO_OFFSET_X)
