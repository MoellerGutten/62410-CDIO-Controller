...
def _calculate_intermediate_points(cross: Cross, h_offset, v_offset) -> tuple[float, float, float, float]:
    ...
    hori_c_to_i = v_offset * cos(-radians(90 - cross.orientation)) # horizontal distance between cross' center and AB or CD
    vert_c_to_i = v_offset * sin(-radians(90 - cross.orientation)) # vertical distance between cross' center and AB or CD
