...
def _calculate_intermediate_points(cross: Cross, h_offset, v_offset) -> tuple[float, float, float, float]:
    ...
    hori_c_to_i = v_offset * cos(radians(35 - cross.orientation)) # horizontal distance between cross' center and AB or CD
    vert_c_to_i = v_offset * sin(radians(35 - cross.orientation)) # vertical distance between cross' center and AB or CD

    # distance from intermediate points to approach points
    hori_i_to_a = h_offset * cos(radians(cross.orientation + 35))    # horizontal distance from AB or CD to approach point
    vert_i_to_a = h_offset * sin(radians(cross.orientation + 35))    # vertical distance from AB or CD to approach point
